...
if ($estado === 'Todas') {
    ...
    $estadosMostrar = ['Activa', 'En progreso']; // Estado por defecto
    ...
    $estadosMostrar = ['Activa', 'En progreso'];
            ...
            <form method="get" class="row g-3">
                ...
                <div class="col-md-3">
                    <select name="estado" class="form-select">
                        <option value="">Mostrar activas y en progreso (por defecto)</option>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="d-flex justify-content-between">
                                ...
                                <?php if ($authHelper->tienePermiso('juntas.edit', $_SESSION['rol_id']) && $jun['Estado'] != 'Completada' && $jun['Estado'] != 'Cancelada'): ?>
                                    <a href="editar_junta.php?id=<?= $jun['JuntaID'] ?>" class="btn btn-sm btn-outline-secondary" title="Editar">
